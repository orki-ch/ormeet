    ...
    <div class="doc stack-lg">
      ...
      <section id="sitzung" class="card stack-sm">
        ...
        <ol>
          ...
          <li><strong>Anträge erfassen:</strong> Ein Traktandum oder Unterpunkt vom Typ «Antrag» (ohne weitere Unterpunkte) ist selbst der Antrag – der Titel ist sein Titel, die Notiz der Antragstext. Beim Start der Sitzung steht er im Protokoll als offener Antrag bereit und wird dort entschieden. Weitere Anträge aus der Sitzung fügst du im Protokoll mit <em>+ Antrag</em> hinzu.</li>
      ...
      <section id="protokoll" class="card stack-sm">
        ...
        <ol>
          ...
          <li>Bei jedem Traktandum oder Unterpunkt <em>+ Eintrag</em>: Der neue Eintrag öffnet sich direkt – Titel und Inhalt tippst du im Eintrag selbst, Typ (Information, Antrag, Pendenz), Themenbereich und bei Anträgen der Beschluss bzw. bei Pendenzen Status, Person und Frist sind Pillen darunter. Ist der Typ beim Traktandum vorgegeben, entfällt die Wahl. Bei angenommenen oder abgelehnten Anträgen kannst du die Stimmen (Ja, Nein, Enthaltungen) eintragen; der Beschluss <em>Vertagt</em> bringt den Antrag als neuen, offenen Antrag ins nächste Vorprotokoll.</li>
