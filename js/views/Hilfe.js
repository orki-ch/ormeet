    ...
    <div class="doc stack-lg">
      ...
      <section id="sitzung" class="card stack-sm">
        ...
        <ol>
          ...
          <li>Traktanden: Klick auf ein Traktandum öffnet die Bearbeitung – Titel, Themenbereich, verantwortliche Personen, Typ, geplante Dauer und Notiz (mehrzeilig, Zeilenumbrüche bleiben erhalten). Wer zusätzlich bearbeiten darf, steht hinter <em>Wer darf zusätzlich bearbeiten</em>. Verschieben und Löschen findest du im ⋮-Menü.</li>
          <li><strong>Unterpunkte</strong> (2.1, 2.2 …): Pro Unterpunkt eine Zeile mit Titel und Typ. Hinter <em>⋯</em> liegen Notiz, verantwortliche Personen, Rechte und <em>+ Unterpunkt zu 2.1</em> – so entstehen Unterpunkte von Unterpunkten (2.1.1). Ohne eigene Angaben gilt für einen Unterpunkt, was beim Punkt darüber steht.</li>
