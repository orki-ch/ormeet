    ...
    <div class="doc stack-lg">
      ...
      <section id="sitzung" class="card stack-sm">
        ...
        <ol>
          ...
          <li>Offene Pendenzen und vertagte Anträge aus früheren Sitzungen werden automatisch übernommen (gelb markiert): Gibt es im neuen Vorprotokoll den Punkt, unter dem sie zuletzt standen (gleiche Titel, z. B. aus derselben Vorlage), erscheinen sie dort als Unterpunkt – sonst als eigenes Traktandum am Ende. Über ⋯ → <em>Vorprotokoll neu von vorheriger Sitzung zusammenstellen</em> baust du das ganze Vorprotokoll (Kopfdaten, Anwesenheit, Gäste, Traktanden) nach der letzten protokollierten Sitzung neu auf; Pendenzen und vertagte Anträge landen dann an ihrem bisherigen Ort.</li>
